package com.acme.learningcenterplataform.profiles.domain.model.aggregates;
...
import com.acme.learningcenterplataform.profiles.domain.model.valueobjects.StreetAddress;
import com.acme.learningcenterplataform.profiles.domain.model.valueobjects.PersonName;
...
public class Profile extends AuditableAbstractAggregateRoot<Profile> {
    ...
    public Profile(CreateProfileCommand command){
        ...
        this.address = new StreetAddress(command.street(), command.number(), command.city(),
